...
if database_url:
    # Render provides PostgreSQL URL like: postgresql://user:pass@host:port/dbname
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = f'sqlite:///{os.path.join(basedir, "jumia_db.sqlite")}'
...
def after_request(response):
    ...
    if origin.startswith('http://localhost') or 'vercel.app' in origin:
